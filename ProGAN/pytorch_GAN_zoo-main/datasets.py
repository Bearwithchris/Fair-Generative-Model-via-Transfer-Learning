...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset_name', type=str,
                        choices=['celeba','celeba_cropped', 'celebaHQ', 'dtd',
                                 'fashionGen', 'cifar10'],
                        help='Name of the dataset.', default='celebaHQ')
    parser.add_argument('--dataset_path', type=str,
                        help='Path to the input dataset', default=" H:/Datasets/CelebA-HQ/data256x256")
    parser.add_argument('-o', help="If it applies, output dataset (mandadory \
                        for celeba_cropped)",
                        type=str, dest="output_dataset", default="./celebA256")
